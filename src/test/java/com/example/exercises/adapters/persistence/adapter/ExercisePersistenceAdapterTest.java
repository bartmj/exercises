package com.example.exercises.adapters.persistence.adapter;

import com.example.exercises.adapters.persistence.ExercisePersistenceAdapter;
...
class ExercisePersistenceAdapterTest {
    ...
    public void getAllExercises_shouldReturnListOfExercises() {
        ...
        assertAll(
                () -> assertEquals(exerciseList.get(0).getExerciseName(), "Przysiad ze sztangą"),
